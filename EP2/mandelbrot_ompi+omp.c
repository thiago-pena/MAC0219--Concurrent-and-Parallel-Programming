...
#pragma omp parallel for default(shared) schedule(dynamic) num_threads(num_threads) private(iteration, z_x, z_y, z_x_squared, z_y_squared, c_y, c_x, i_x)
